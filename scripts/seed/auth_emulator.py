    ...
    for user_data in USER_DATA:
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                print(f"   🔑 Вход в систему пользователем {user_data['username']}")
                ...
                if login_response.status_code == 200:
                    ...
                    print(f"   👤 Получение профиля пользователя {user_data['username']}")
                    ...
                    if profile_response.status_code == 200:
                        ...
                        print(f"   🔄 Обновление профиля пользователя {user_data['username']}")
                        ...
                        if update_response.status_code == 200:
                            ...
                            if user_data["is_admin"] and admin_token:
                                ...
                                print(f"   👑 Получение списка ролей для админа {user_data['username']}")
                                ...
                                if roles_response.status_code == 200:
                                    ...
                                    if admin_role_id:
                                        print(f"   👑 Присвоение роли админа пользователю {user_data['username']}")
